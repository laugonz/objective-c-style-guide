# Centralway Objective-C Style Guide

This style guide outlines the coding conventions of the iOS team at Centralway. It is based on the conventions of the NYTimes team.
...
* The else in if/else should be surrounded by brackets. 
...
For function documentation there is a nice Xcode plugin that we use: https://github.com/onevcat/VVDocumenter-Xcode
